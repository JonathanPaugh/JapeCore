...
namespace JapeDatabase
{
    public partial class Database : RestService
    {
        ...
        public new static IEnumerable<ICommandArg> Args => new ICommandArg[]
        {
            ...
            CommandArg<string>.CreateOptional("--mongo", "Environment variable for mongo connection"),
            CommandArg<string>.CreateOptional("--redis", "Environment variable for redis connection"),
        };
